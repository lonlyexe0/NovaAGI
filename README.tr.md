...
> **Linux kullanıcıları:** Avalonia masaüstü istemcisi, Python köprüsü, GPU seçenekleri ve sorun giderme için [Linux kurulum rehberine](README.LINUX.md) bakabilirsiniz.
